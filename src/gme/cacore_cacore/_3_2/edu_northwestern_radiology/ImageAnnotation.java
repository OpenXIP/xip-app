 ...
 *       &lt;sequence>
 *         &lt;element name="imageReferenceCollection" maxOccurs="unbounded">
 *           &lt;complexType>
 *             &lt;complexContent>
 ...
 *         &lt;/element>
 *       &lt;/sequence>
 *       &lt;attribute name="type" use="required" type="{gme://caCORE.caCORE/3.2/edu.northwestern.radiology.AIM}ImageAnnotationIdentifier" />
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
    ...
    extends Annotation
{
    ...
    protected List<ImageAnnotation.ImageReferenceCollection> imageReferenceCollection;
    ...
    protected ImageAnnotationIdentifier type;
     ...
     * This is why there is not a <CODE>set</CODE> method for the imageReferenceCollection property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getImageReferenceCollection().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ImageAnnotation.ImageReferenceCollection> getImageReferenceCollection() {
        if (imageReferenceCollection == null) {
            imageReferenceCollection = new ArrayList<ImageAnnotation.ImageReferenceCollection>();
        }
        return this.imageReferenceCollection;
    }
     ...
     *     
     */
    public ImageAnnotationIdentifier getType() {
        return type;
    }
     ...
     *     
     */
    public void setType(ImageAnnotationIdentifier value) {
        this.type = value;
    }

...
public class ExceptionDialog {
	...
	JLabel lblLine_1;// = new JLabel("Unable to launch selected application!", JLabel.LEFT);
    JLabel lblLine_2;// = new JLabel("Please verify application path.", JLabel.LEFT);
    JOptionPane optPane = new JOptionPane(null, JOptionPane.YES_OPTION);
    ImageIcon iconLogo =  new ImageIcon("./src/XIP/gif/xip-logo.GIF");
